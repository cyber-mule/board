  ...
  <div class="page-section">
    ...
    <form class="form-grid form-grid--wide" @submit.prevent="applyFilters">
      ...
      <div class="cluster cluster--center form__field--offset">
        <Checkbox id="include-drafts" v-model:checked="filters.include_drafts" />
      ...
      <DialogContent class="max-w-2xl">
        ...
        <div class="stack">
          ...
          <div class="cluster cluster--center">
            <Checkbox id="create-default" v-model:checked="createForm.is_default" />
    ...
    <Dialog v-model:open="showEditModal">
      <DialogContent class="max-w-2xl">
        ...
        <div class="stack">
          ...
          <div class="cluster cluster--center">
            <Checkbox id="edit-default" v-model:checked="editForm.is_default" />

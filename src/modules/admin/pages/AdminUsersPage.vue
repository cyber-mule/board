...
async function handleCreate() {
  ...
  try {
    const payload: CreateAdminUserRequest = {
      ...
      email_verified: createForm.email_verified || false,
...
function openStatusModal() {
  ...
  statusForm.status = selectedUser.value.status || 'active';
    ...
    <Dialog v-model:open="showCreateModal">
      <DialogContent class="max-w-xl">
        ...
        <div class="stack">
          ...
          <div class="cluster cluster--center">
            <Checkbox id="create-verified" v-model:checked="createForm.email_verified" />
